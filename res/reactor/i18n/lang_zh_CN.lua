...
return {
  ...
  ['IC2:reactorPlating'] = '反应堆隔板',
  ['IC2:reactorPlatingExplosive'] = '密封反应堆隔板',
  ['IC2:reactorPlatingHeat'] = '高热容反应堆隔板',
  ['IC2:reactorVent'] = '散热片',
  ['IC2:reactorVentCore'] = '反应堆散热片',
  ['IC2:reactorVentDiamond'] = '高级散热片',
  ['IC2:reactorVentGold'] = '超频散热片',
  ['IC2:reactorVentSpread'] = '元件散热片',
  alert_message = '消息框内容',
  alert_title = '提示',
  backup_saved = '备份完成',
  black = '黑色',
  ...
  confirm_delete = '确认删除',
  confirm_exit = '确认退出',
  confirm_validation_error = '确认验证错误',
  copy = '复制',
  create_new = '<新建...>',
  cyan = '青色',
  delete = '删除',
  ...
  profile_heat_capacity_not_equal = '各布局的反应堆热容不匹配: %s\n这可能导致反应堆爆炸.',
  profile_heatup = '升温布局',
  ...
  prompt_confirm_validation_error = '配置存在错误:\n%s\n是否继续？',
  purple = '紫色',
