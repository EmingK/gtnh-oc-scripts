...
return {
  ...
  enabled = '已启用',
  eu_address = 'EU存储地址',
  eu_high_threshold = '高电量阈值',
  eu_logic_and = '组合与',
  eu_logic_mode = '逻辑模式',
  eu_logic_or = '组合或',
  eu_logic_start = '开机逻辑',
  eu_logic_stop = '停机逻辑',
  eu_low_threshold = '低电量阈值',
  eu_storage = '电量控制',
  eu_storage_config = '编辑EU存储',
  eu_storage_monitor = 'EU存储',
  eu_storage_name = '存储名称',
  eu_status_format = '%s / %s EU (%d%%)',
  global_control = '全局控制',
  gray = '灰色',
  green = '绿色',
  height = '高度',
  input_prompt_eu_high = '输入高电量阈值（0.0-1.0）',
  input_prompt_eu_low = '输入低电量阈值（0.0-1.0）',
  input_prompt_eu_name = '输入存储名称，中文可从外部粘贴',
