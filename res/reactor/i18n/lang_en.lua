...
return {
  ...
  edit = 'Edit',
  enabled = 'Enabled',
  eu_address = 'EU Storage address',
  eu_high_threshold = 'High EU threshold',
  eu_logic_and = 'AND ',
  eu_logic_mode = 'Logic combination mode',
  eu_logic_or = 'OR ',
  eu_logic_start = 'Start reactor logic',
  eu_logic_stop = 'Stop reactor logic',
  eu_low_threshold = 'Low EU threshold',
  eu_storage = 'EU Storage',
  eu_storage_config = 'Edit EU Storage',
  eu_storage_monitor = 'EU Storages',
  eu_storage_name = 'Storage name',
  eu_status_format = '%s / %s EU (%d%%)',
  global_control = 'Global control',
  gray = 'Gray',
  green = 'Green',
  height = 'Height',
  input_prompt_eu_high = 'Input high EU threshold (0.0-1.0)',
  input_prompt_eu_low = 'Input low EU threshold (0.0-1.0)',
  input_prompt_eu_name = 'Input storage name',
