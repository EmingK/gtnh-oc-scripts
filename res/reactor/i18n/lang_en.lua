...
return {
  ...
  ['gregtech:gt.rodExcitedPlutonium'] = 'Fuel rod (liquid plutonium)',
  ['gregtech:gt.rodExcitedPlutonium2'] = 'Double fuel rod (liquid plutonium)',
  ['gregtech:gt.rodExcitedPlutonium4'] = 'Quad fuel rod (liquid plutonium)',
  ['gregtech:gt.rodExcitedUranium'] = 'Fuel rod (liquid uranium)',
  ['gregtech:gt.rodExcitedUranium2'] = 'Double fuel rod (liquid uranium)',
  ['gregtech:gt.rodExcitedUranium4'] = 'Quad fuel rod (liquid uranium)',
  ['gregtech:gt.rodGlowstone'] = 'Fuel rod (glowstone)',
  ['gregtech:gt.rodHighDensityPlutonium'] = 'Fuel rod (compressed plutonium)',
  ['gregtech:gt.rodHighDensityPlutonium2'] = 'Double fuel rod (compressed plutonium)',
  ['gregtech:gt.rodHighDensityPlutonium4'] = 'Quad fuel rod (compressed plutonium)',
  ['gregtech:gt.rodHighDensityUranium'] = 'Fuel rod (compressed uranium)',
  ['gregtech:gt.rodHighDensityUranium2'] = 'Double fuel rod (compressed uranium)',
  ['gregtech:gt.rodHighDensityUranium4'] = 'Quad fuel rod (compressed uranium)',
