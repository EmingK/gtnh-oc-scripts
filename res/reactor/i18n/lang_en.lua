...
return {
  ...
  ['IC2:reactorPlating'] = 'Reactor plating',
  ['IC2:reactorPlatingExplosive'] = 'Containment reactor plating',
  ['IC2:reactorPlatingHeat'] = 'Heat-capacity reactor plating',
  ['IC2:reactorVent'] = 'Heat vent',
  ...
  confirm_validation_error = 'Validation error',
  copy = 'Copy',
  create_new = '<create...>',
  cyan = 'Cyan',
  delete = 'Delete',
  ...
  profile_heat_capacity_not_equal = 'Profile heat capacity mismatch: %s\nThis may cause unexpected reactor explosion.',
  ...
  prompt_confirm_validation_error = 'Configuration has errors:\n%s\nStill continue?',
  purple = 'Purple',
